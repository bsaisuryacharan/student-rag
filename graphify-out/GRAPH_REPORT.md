# Graph Report - student-rag  (2026-06-20)

## Corpus Check
- 45 files · ~16,827 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 369 nodes · 950 edges · 28 communities (24 shown, 4 thin omitted)
- Extraction: 68% EXTRACTED · 32% INFERRED · 0% AMBIGUOUS · INFERRED: 303 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c38daab6`
...
Cohesion: 0.14
Nodes (32): ParsedDocument, Settings, IngestionService, Settings, Settings, DenseEncoder, IngestionService, Settings (+24 more)
...
Cohesion: 0.11
Nodes (11): DenseEncoder, RetrievedChunk, Settings, SparseEncoder, VectorStore, Filter, DenseEncoder, SparseEncoder (+3 more)
...
Cohesion: 0.31
Nodes (9): AsyncClient, _safe_filename(), DocResult, main(), print_report(), Concurrent upload load test — simulates N users uploading documents simultaneous, upload_and_stream(), Path (+1 more)
...
Cohesion: 0.09
Nodes (28): build_groq_client(), build_openai_client(), build_qdrant_client(), AsyncOpenAI, AsyncQdrantClient, Settings, get_settings(), configure_logging() (+20 more)
...
- **Why does `Settings` connect `Community 2` to `Community 1`, `Community 3`, `Community 5`, `Community 9`, `Community 26`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `IngestionService` connect `Community 3` to `Community 2`, `Community 26`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `VectorStore` connect `Community 9` to `Community 1`, `Community 2`, `Community 26`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Are the 49 inferred relationships involving `Settings` (e.g. with `AnswerResponse` and `ParsedDocument`) actually correct?**
